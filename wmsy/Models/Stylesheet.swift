...
enum Stylesheet {
    ...
    enum Colors {
        ...
        static let WMSYOuterSpace = UIColor(red:0.24, green:0.29, blue:0.25, alpha:1.0)
        static let WMSYMummysTomb = UIColor(red:0.49, green:0.55, blue:0.51, alpha:1.0)
        static let WMSYAshGrey = UIColor(red:0.70, green:0.75, blue:0.72, alpha:1.0)
        static let WMSYIsabelline = UIColor(red:0.92, green:0.95, blue:0.93, alpha:1.0)
        static let WMSYSeaFoamGreen = UIColor(red:0.63, green:0.89, blue:0.76, alpha:1.0)
